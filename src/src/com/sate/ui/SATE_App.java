...
class ReporteManualScreen extends JFrame {
	...
	private JPanel crearPanelUbicacion(JPanel panel) {
		...
		gbc.gridx = 1;
		panel.add(latitudTextField, gbc);
		...
		gbc.gridx = 1;
		panel.add(longitudTextField, gbc);
	...
	/**
	 * Ensambla los campos de Latitud y Longitud en el formato WKT POINT. MySQL usa
	 * WKT con el orden: LONGITUD LATITUD.
	 */
...
class MainDashboard extends JFrame {
	...
	public MainDashboard() {
		...
		applyButton.addActionListener(e -> {
			...
			JOptionPane.showMessageDialog(this,
					"Simulando filtrado de eventos de tipo: " + tipoComboBox.getSelectedItem(), "Filtro Aplicado",
	...
	/**
	 * Método para cargar los eventos desde la base de datos y actualizar la UI
	 * (tabla y mapa).
	 */
	private void loadEvents() {
		...
		for (Evento evento : eventos) {
			// Se usa substring(0, 19) para limpiar la hora de milisegundos para una mejor
			// presentación
			model.addRow(new Object[] { evento.getIdEvento(), evento.getTipo(), evento.getFechaHora().substring(0, 19),
