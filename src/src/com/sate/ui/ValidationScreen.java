...
public class ValidationScreen extends JFrame {
    ...
    public ValidationScreen() {
        ...
        detailTextArea = new JTextArea("Seleccione un reporte para ver los detalles aquí:\n\n"
        ...
        rejectButton.addActionListener(e -> JOptionPane.showMessageDialog(this, "Reporte Rechazado. Se notifica al usuario.", "Validación", JOptionPane.WARNING_MESSAGE));
        approveButton.addActionListener(e -> JOptionPane.showMessageDialog(this, "Reporte Aprobado. Evento creado y listo para notificación.", "Validación", JOptionPane.INFORMATION_MESSAGE));
