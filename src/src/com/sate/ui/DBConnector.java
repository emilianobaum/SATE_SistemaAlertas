...
public class DBConnector { // La clase debe ser PUBLIC
	...
	public static Connection getConnection() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Error de Conexión a la Base de Datos: " + e.getMessage(), "Error JDBC",
	...
	public static List<Evento> getEventos() {
		...
		try (Connection conn = getConnection();
			...
			JOptionPane.showMessageDialog(null, "Error al cargar eventos: " + e.getMessage(), "Error DB",
					JOptionPane.ERROR_MESSAGE);
		}
		return eventos;
	}
